...
1. В поле "Номер катры" вести номер карты: 4444 4444 4444 4442 , статус: DECLINED
2. В поле "Месяц" ввести валидное значение в формате "ММ": 01, 02, .... , 12
3. В поле "Год" ввести валидное значение в формате "ГГ": любое значение в промежутке текущий год, .... , текущий год + 5 лет
4. В поле "Владелец" ввести валидное значение любыми символами в количестве от одного: Я
5. В поле "CVC/CVV" ввести валидное значение, трехзначный номер: 123
...
## 1.8 Отправка формы с введением 15-ти значного номера карты, цифрами
1. В поле "Номер карты" ввести номер катры из 15 символов: 4444 4444 4444 444
2. В поле "Месяц" ввести валидное значение в формате "ММ": 01, 02, .... , 12
3. В поле "Год" ввести валидное значение в формате "ГГ": любое значение в промежутке текущий год, .... , текущий год + 5 лет
4. В поле "Владелец" ввести валидное значение любыми символами в количестве от одного: Я
5. В поле "CVC/CVV" ввести валидное значение, трехзначный номер: 123
...
*Ожидаемый результат:* Запрос в банк НЕ отправлен. Под полем "Номер Карты" появилстя красным цветом текст ошибки "Неверный формат"
...
## 1.10 Отправка формы, заполнив поле "Месяц" НЕ валиным значением 00
1. В поле "Номер карты" ввести валидное значение: 16-ти значный номер 4444 4444 4444 4441 со статусом: APPROVED
...
## 1.11 Отправка формы, заполнив поле "Месяц" НЕ валиным значением 13
1. В поле "Номер карты" ввести валидное значение: 16-ти значный номер 4444 4444 4444 4441 со статусом: APPROVED
...
## 1.13 Отправка формы, введя "Месяц" на одим меньше текущего и введя в поле "Год" текущий
1. В поле "Номер карты" ввести валидное значение: 16-ти значный номер 4444 4444 4444 4441 со статусом: APPROVED
